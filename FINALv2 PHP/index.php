...
<body onload="checkLoginStatus()">
    ...
    <section id="about" class="flex-row">
        ...
        <div class="text-wrapper" data-aos="fade-left" data-aos-duration="1000">
            ...
            <div class="sign">
                <img src="./img/sign/sign-light.png" alt="#" id="signImg">
            </div>
        </div>

        <div class="img-wrapper" data-aos="fade-left" data-aos-duration="1000">
            <img src="./img/About/about-ambatu.png" alt="#" id="ambatuImg">
        </div>
    </section>
        ...
        <div class="team-carousel owl-carousel owl-theme" data-aos="fade-right" data-aos-duration="1000">
            ...
            <div class="team-card">
                ...
                <div class="img-wrapper">
                    <img src="./img/team/team-albert-1.png" alt="#">
                </div>
            ...
            <div class="team-card">
                ...
                <div class="img-wrapper">
                    <img src="./img/team/team-risu.png" alt="#">
                </div>
            ...
            <div class="team-card">
                ...
                <div class="img-wrapper">
                    <img src="./img/team/team-ambatu.png" alt="#">
                </div>
    ...
    <section id="reviews">
        ...
        <div class="review-carousel owl-carousel owl-theme" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="review-item">
                <div class="container">
                    <div class="img-box">
                        <img src="./img/Review/marco.jpg" alt="#">
                    </div>
                    <div class="text-holder">
            ...
            <div class="review-item">
                <div class="container">
                    <div class="img-box">
                        <img src="./img/Review/rie.png" alt="#">
                    </div>
                    <div class="text-holder">
            ...
            <div class="review-item">
                <div class="container">
                    <div class="img-box">
                        <img src="./img/Review/charlie.png" alt="#">
                    </div>
                    <div class="text-holder">

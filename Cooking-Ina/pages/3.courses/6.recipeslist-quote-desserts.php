...
<section id="recipes-dessert">
    ...
    <div class="menu">
        <div class="food-items">
            <img src="./img/RECIPES/3-DESSERT/salad.png">
            <div class="details">
        ...
        <div class="food-items">
            <img src="./img/RECIPES/3-DESSERT/bibingka.png">
            <div class="details">
                <div class="details-sub">
                    <h2>Bibingka</h2>
                </div>
        ...
        <div class="food-items">
            <img src="./img/RECIPES/3-DESSERT/banana-bread.png">
            <div class="details">
                <div class="details-sub">
                    <h2>Banana Bread</h2>
                </div>
        ...
        <div class="food-items">
            <img src="./img/RECIPES/3-DESSERT/buko-pandan.png">
            <div class="details">
                <div class="details-sub">
                    <h2>Buko Pandan</h2>
                </div>
                    ...
                    <div class="containers">
                        <div class="top">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td> young coconut (cut into strips) </td>
                                    <td> 1 1/2 cup </td>
                                ...
                                <tr>
                                    <td> Table cream or all-purpose cream </td>
                                    <td> 8 ounces</td>
                                </tr>
                                ...
                                <tr>
                                    <td> Buko Pandan flavoring </td>
                                    <td> 6 drops </td>
                                </tr>

                                <tr>
                                    <td> vanilla ice cream (optional) </td>
                                    <td> 2 scoops </td>
                                </tr>

                                <tr>
                                    <td> sago pearls cooked (optional) </td>
                                    <td> 1/2 cup </td>
                                </tr>
        ...
        <div class="food-items">
            <img src="./img/RECIPES/3-DESSERT/fruit-cocktail-float.png">
            <div class="details">
                <div class="details-sub">
                    ...
                    <div class="containers">
                        <div class="top">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td> 473 ml cold heavy whipping cream </td>
                                    <td> 16 oz. </td>
                                </tr>

                                <tr>
                                    <td> 225 ml table cream or all purpose cream </td>
                                    <td> 7.6 oz. </td>
                                </tr>

                                <tr>
                                    <td> fruit cocktail </td>
                                    <td> 2 cans of 15.25 oz. </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td> 8 to 10 pieces </td>
                                </tr>

                                <tr>
                                    <td> crushed Graham </td>
                                    <td> 3 tbsp </td>
                                </tr>

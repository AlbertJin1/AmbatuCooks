        ...
        <div class="blog-carousel owl-carousel owl-theme" data-aos="fade-right" data-aos-duration="1000">
            ...
            <a href="recipes-list.php#popup1-main" class="blog-post">
                ...
                <div class="img-wrapper">
                    <img src="./img/Blog/1-Miso-Ramen.jpg" alt="#">
            ...
            <a href="recipes-list.php#popup1-appe" class="blog-post">
                ...
                <div class="img-wrapper">
                    <img src="./img/Blog/2-Chawanmushi.jpg" alt="#">
                    <div class="overlay"><i class="icon bx bx-link"></i></div>
                </div>
            ...
            <a href="recipes-list.php#popup3-dessert" class="blog-post">
                ...
                <div class="img-wrapper">
                    <img src="./img/Blog/3-Japanese Strawberry Shortcake.jpg" alt="#">
                    <div class="overlay"><i class="icon bx bx-link"></i></div>
                </div>
            ...
            <a href="recipes-list.php#popup2-beve" class="blog-post">
                ...
                <div class="img-wrapper">
                    <img src="./img/Blog/4-Matcha Latte.jpg" alt="#">
                    <div class="overlay"><i class="icon bx bx-link"></i></div>
                </div>
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup1-main">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/1-MAIN DISH/1-Miso-Ramen.jpg" alt="#">
                        </div>
                        <div class="text">
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup2-main">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/1-MAIN DISH/2-Japanese-Curry.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup3-main">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/1-MAIN DISH/3-Tonkatsu.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
                                <h2>Tonkatsu</h2>
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup4-main">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/1-MAIN DISH/4-Oyakodon.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
                                <h2>Oyakodon</h2>
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup1-appe">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/2-APPETIZER/1-Chawanmushi.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
                                <h2>Chawanmushi</h2>
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup2-appe">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/2-APPETIZER/2-Blistered Shishito Peppers.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup3-appe">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/2-APPETIZER/3-Agedashi Tofu.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
                                <h2>Agedashi Tofu</h2>
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup4-appe">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/2-APPETIZER/4-Datemaki.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
                                <h2>Datemaki</h2>
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup4-dessert">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/3-DESSERT/4-Japanese Cheesecake.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup1-dessert">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/3-DESSERT/1-Basque Burnt Cheesecake.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup2-dessert">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/3-DESSERT/2-Matcha Swiss Roll.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup3-dessert">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/3-DESSERT/3-Japanese Strawberry Shortcake.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
        ...
        <div id="drinks" class="menu-tab-content">
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup1-beve">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/4-BEVERAGE/1-Amazake.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
                                <h2>Amazake</h2>
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup3-beve">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/4-BEVERAGE/2-Matcha Latte.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
                                <h2>Matcha Latte</h2>
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup3-beve">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/4-BEVERAGE/3-Royal Milk Tea.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
            ...
            <div class="menu-item">
                <div class="menu-item-inner">
                    <a href="recipes-list.php#popup4-beve">
                        <div class="food-img">
                            <img src="./img/MAIN MENU/4-BEVERAGE/4-Honey Ginger Tea.jpg" alt="#">
                        </div>
                        <div class="text">
                            <div class="dish-details">
